...
export default function DraggableBoxes({
  ...
  return (
    <div
      id='drag'
      className={`py-0 px-2 bg-[#F6F6F6] w-[260px]  text-[#1B1919] drag${id} opacity-0 `}>
      <span className='flex justify-between  py-2 uppercase px-1'>
        {name}
        <span className='border-2 border-primary  rounded-full w-6 h-6 flex justify-center items-center '>
      ...
      <span className='flex justify-between  pt-2 pb-4 px-1'>
        ...
        <Link
          href={a}
          className='hover:child:rotate-0 flex items-center after:transition-all after:duration-400 after:h-[1px] see-live '>
          see live
